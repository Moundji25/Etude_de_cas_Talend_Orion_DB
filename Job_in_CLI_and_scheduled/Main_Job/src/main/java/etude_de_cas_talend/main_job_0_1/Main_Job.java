...
package etude_de_cas_talend.main_job_0_1;
...
/**
 * Job: Main_Job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Main_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Main_Job";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Main_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		etude_de_cas_talend.job01_customer_dim_0_1.Job01_Customer_Dim childJob_tRunJob_1 = new etude_de_cas_talend.job01_customer_dim_0_1.Job01_Customer_Dim();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		etude_de_cas_talend.job02_product_dim_0_1.Job02_Product_Dim childJob_tRunJob_2 = new etude_de_cas_talend.job02_product_dim_0_1.Job02_Product_Dim();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		etude_de_cas_talend.job03_organization_dim_0_1.Job03_Organization_Dim childJob_tRunJob_3 = new etude_de_cas_talend.job03_organization_dim_0_1.Job03_Organization_Dim();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		etude_de_cas_talend.job04_geography_dim_0_1.Job04_Geography_Dim childJob_tRunJob_4 = new etude_de_cas_talend.job04_geography_dim_0_1.Job04_Geography_Dim();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		etude_de_cas_talend.job05_order_fact_0_1.Job05_Order_Fact childJob_tRunJob_5 = new etude_de_cas_talend.job05_order_fact_0_1.Job05_Order_Fact();
	    // pass DataSources
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "cmd /c echo MAIN JOB DONE !!!" ,env_tSystem_1);
 ...
 */
    ...
    public static void main(String[] args){
        final Main_Job Main_JobClass = new Main_Job();

        int exitCode = Main_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Job.class.getClassLoader().getResourceAsStream("etude_de_cas_talend/main_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Main_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Main_Job");
        }
...
/************************************************************************************************
 *     62009 characters generated by Talend Open Studio for Data Integration 
